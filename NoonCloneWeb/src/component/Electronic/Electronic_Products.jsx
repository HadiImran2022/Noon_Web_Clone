...
const Electronic_Products = (electronic_props) => {
    const {img_url,title,pTag,price,oldPrice,dTag,stock} = electronic_props.electronic_data
  return (
    <div className="mb-5">
...
export default Electronic_Products
